...
class robot:
    ...
    def sense(self):
        ...
        for i, land_mark in enumerate(self.landmarks):
            dx = land_mark[0] - self.x + self.rand() * self.measurement_noise
            dy = land_mark[1] - self.y + self.rand() * self.measurement_noise
